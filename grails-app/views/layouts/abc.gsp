        ...
        <div class = "container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbar-collapse3">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class = ${myCurrentPage.equals("Create")? "active":""}><a href="/user/create" id = "a2">Create</a></li>
                    <li class = ${myCurrentPage.equals("Show")? "active":""}><a href="/user/show" id = "a3">Show</a></li>
                    <li class = ${myCurrentPage.equals("List")? "active":""}><a href="/user/list" id = "a4">List</a></li>
                </ul>
            </div>
        </div>
    </nav>
