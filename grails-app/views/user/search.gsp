    ...
    <div class="box ">
        <g:form action="test" controller="user" method="post" class="form-horizontal" >
            <div class="form-group form-group-lg">
                ...
                <div class="col-sm-8">
                    <g:textField name="text1" class="form-control" style="padding:5px; margin:5px;"/><br>
                </div>
            </div>
            ...
            <div class="form-group form-group-lg">
                ...
                <div class="col-sm-8">
                    <g:textField  name="text2" class="form-control" style="padding:5px; margin:5px;"/><br>
                </div>
            </div>
            <div class="form-group form-group-lg">
            <label for="selection" class="col-sm-3 control-label">Condition</label>
                <div class="col-sm-8">
                    <g:select name = "selection" from ="${[[abc: "Greater",xyz:1],[abc:"Equal",xyz:2],[abc : "Less", xyz : 3]]}"
                          noSelection="['':'SELECT' ]" onchange="${remoteFunction(params : 'this.value')}"
                          optionValue="abc" optionKey="xyz"  style="padding:5px; margin:5px;"/><br>
                </div>
            </div>
            <div class="form-group form-group-lg">
